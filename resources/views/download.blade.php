...
<section class="py-16 bg-gradient-to-br from-primary to-primary-container">
    <div class="px-4 mx-auto text-center max-w-7xl sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col justify-center gap-4 sm:flex-row">
           <a href="https://github.com/itsGenreee/HOA-Montana_Homeowners/releases/download/v1.0.0/HOA.Montana.-.Mobile.App.apk" class="flex items-center justify-center px-8 py-4 font-medium transition-colors duration-200 rounded-lg bg-on-primary text-primary hover:bg-on-primary/90">
